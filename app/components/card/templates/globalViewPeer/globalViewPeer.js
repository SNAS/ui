...
//angular.module('bmp.components.card', []) //for some reason cannot add them to card
angular.module('bmpUiApp', [])

.controller('BmpCardGlobalPeerController', ["$scope", "apiFactory", function ($scope, apiFactory) {
    console.log("THE GLOBAL PEER");
    //window.SCOPER = $scope;
    //
