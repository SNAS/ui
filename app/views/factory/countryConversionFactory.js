...
angular.module('bmpUiApp')
  .factory('countryConversionFactory', function () {

    var countryConversionFactory = {};
...
// Read data from ISO's file
    /*
     ...
     countryNames.forEach(function (line) {
     var row = line.split(';'),
     code = row.pop(),
     nameParts = row.pop(),
     name = '';
     ...
     * @api public
     */
    var countries = countryNames["countries"];
    var continents = countryNames["continents"];


    countryConversionFactory.getCode = function (name) {
      ...
      return result;
      //return fromName[name.toUpperCase()]?fromName[name.toUpperCase()]:name;
    };

    countryConversionFactory.getContinent = function (code) {
      var result = "[UNKNOWN]";
      for (var country in countries) {
        if (code.toUpperCase() === country)
          result = continents[countries[country]["continent"]];
      }
      return result;
    };
     ...
     * @api public
     */
    countryConversionFactory.getName = function (code) {
      var result = code.toUpperCase();
      for (var country in countries) {
        if (result === country)
          result = countries[country]["name"];
      }
      return result;
    };
     ...
     * @api public
     */
    countryConversionFactory.getAllCodes = function () {
     ...
     * @api public
     */
    countryConversionFactory.getAllNames = function () {
    ...
    return countryConversionFactory;
