...
angular.module('bmpUiApp')
  .factory('apiFactory', function ($http, $q, $location) {
    ...
    apiFactory.getPeerLinks = function (peerHashId, mt_id) {
      return $http.get(urlBase + "linkstate/links/peer/" + peerHashId + "/" + mt_id + "?telemetry");
    };

    apiFactory.getSPFospf = function (peerHashId, routerId, mt_id) {
      return $http.get(urlBase + "linkstate/spf/peer/" + peerHashId + "/ospf/" + routerId + "/" + mt_id + "?telemetry");
    };

    apiFactory.getSPFisis = function (peerHashId, routerId, mt_id) {
      return $http.get(urlBase + "linkstate/spf/peer/" + peerHashId + "/isis/" + routerId + "/" + mt_id + "?telemetry");
    };
