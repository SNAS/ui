...
angular.module('bmp.components.authentication', [])
  .factory('AuthenticationService',
    ['Base64', '$http', '$cookies', 'apiFactory',
      function (Base64, $http, $cookies, apiFactory) {
        var service = {};

        service.login = function (formData) {
          return apiFactory.login(formData);
        };
