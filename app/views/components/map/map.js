...
.controller('MapController', ["$scope", "$rootScope", "$timeout", "apiFactory", "leafletData", "$compile", "$window", function ($scope, $rootScope, $timeout, apiFactory, leafletData, $compile, $window) {
